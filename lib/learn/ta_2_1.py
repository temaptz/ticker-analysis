...
class Ta21LearningCard:
    ...
    def get_x(self) -> list:
        ...
        return [
            ...
            learn_utils.to_numpy_float(self.forecast_price_change),
            learn_utils.to_numpy_float(self.market_volume),
            learn_utils.to_numpy_float(self.rsi),
            learn_utils.to_numpy_float(self.macd),

            learn_utils.to_numpy_float(self.revenue_ttm),
            learn_utils.to_numpy_float(self.ebitda_ttm),
            learn_utils.to_numpy_float(self.market_capitalization),
            learn_utils.to_numpy_float(self.total_debt_mrq),
            learn_utils.to_numpy_float(self.eps_ttm),
            learn_utils.to_numpy_float(self.pe_ratio_ttm),
            learn_utils.to_numpy_float(self.ev_to_ebitda_mrq),
            learn_utils.to_numpy_float(self.dividend_payout_ratio_fy),

            learn_utils.to_numpy_float(self.news_influence_score_0),
            learn_utils.to_numpy_float(self.news_influence_score_1),
            learn_utils.to_numpy_float(self.news_influence_score_2),
            learn_utils.to_numpy_float(self.news_influence_score_3),
            learn_utils.to_numpy_float(self.news_influence_score_4),

            learn_utils.to_numpy_float(self.price_change_2_days_min),
            learn_utils.to_numpy_float(self.price_change_2_days_max),
            learn_utils.to_numpy_float(self.price_change_1_week_min),
            learn_utils.to_numpy_float(self.price_change_1_week_max),
            learn_utils.to_numpy_float(self.price_change_2_week_min),
            learn_utils.to_numpy_float(self.price_change_2_week_max),
            learn_utils.to_numpy_float(self.price_change_3_week_min),
            learn_utils.to_numpy_float(self.price_change_3_week_max),
            learn_utils.to_numpy_float(self.price_change_1_month_min),
            learn_utils.to_numpy_float(self.price_change_1_month_max),
            learn_utils.to_numpy_float(self.price_change_2_month_min),
            learn_utils.to_numpy_float(self.price_change_2_month_max),
            learn_utils.to_numpy_float(self.price_change_3_month_min),
            learn_utils.to_numpy_float(self.price_change_3_month_max),
            learn_utils.to_numpy_float(self.price_change_4_month_min),
            learn_utils.to_numpy_float(self.price_change_4_month_max),
            learn_utils.to_numpy_float(self.price_change_5_month_min),
            learn_utils.to_numpy_float(self.price_change_5_month_max),
            learn_utils.to_numpy_float(self.price_change_6_month_min),
            learn_utils.to_numpy_float(self.price_change_6_month_max),
            learn_utils.to_numpy_float(self.price_change_7_month_min),
            learn_utils.to_numpy_float(self.price_change_7_month_max),
            learn_utils.to_numpy_float(self.price_change_8_month_min),
            learn_utils.to_numpy_float(self.price_change_8_month_max),
            learn_utils.to_numpy_float(self.price_change_9_month_min),
            learn_utils.to_numpy_float(self.price_change_9_month_max),
            learn_utils.to_numpy_float(self.price_change_10_month_min),
            learn_utils.to_numpy_float(self.price_change_10_month_max),
            learn_utils.to_numpy_float(self.price_change_11_month_min),
            learn_utils.to_numpy_float(self.price_change_11_month_max),
            learn_utils.to_numpy_float(self.price_change_1_year_min),
            learn_utils.to_numpy_float(self.price_change_1_year_max),
            learn_utils.to_numpy_float(self.price_change_2_years_min),
            learn_utils.to_numpy_float(self.price_change_2_years_max),
            learn_utils.to_numpy_float(self.price_change_3_years_min),
            learn_utils.to_numpy_float(self.price_change_3_years_max),

            learn_utils.to_numpy_float(self.price_change_2_days),
            learn_utils.to_numpy_float(self.price_change_1_week),
            learn_utils.to_numpy_float(self.price_change_2_week),
            learn_utils.to_numpy_float(self.price_change_3_week),
            learn_utils.to_numpy_float(self.price_change_1_month),
            learn_utils.to_numpy_float(self.price_change_2_month),
            learn_utils.to_numpy_float(self.price_change_3_month),
            learn_utils.to_numpy_float(self.price_change_4_month),
            learn_utils.to_numpy_float(self.price_change_5_month),
            learn_utils.to_numpy_float(self.price_change_6_month),
            learn_utils.to_numpy_float(self.price_change_7_month),
            learn_utils.to_numpy_float(self.price_change_8_month),
            learn_utils.to_numpy_float(self.price_change_9_month),
            learn_utils.to_numpy_float(self.price_change_10_month),
            learn_utils.to_numpy_float(self.price_change_11_month),
            learn_utils.to_numpy_float(self.price_change_1_year),
            learn_utils.to_numpy_float(self.price_change_2_years),
            learn_utils.to_numpy_float(self.price_change_3_years),
        ]
