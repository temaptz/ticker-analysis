...
def instrument_recommendation_create(state: State) -> State:
    ...
    if uid:
        ...
        2. Цена покупки должна быть на 2.5% ниже текущей стоимости.
        3. Подбери количество единиц инструмента для покупки так чтобы общая стоимость покупки(количество*цена) было меньше 25% от всех доступных средств.            
        4. Если покупка нецелесообразна, то создай торговую заявку с количество единиц 0.
        '''
