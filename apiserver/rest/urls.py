...
urlpatterns = [
    ...
    path('instrument/history_forecasts_graph', views.instrument_history_forecasts_graph),
    path('instrument/fundamentals', views.instrument_fundamentals),
    path('instrument/fundamentals_history', views.instrument_fundamentals_history),
    path('instrument/prediction_graph', views.instrument_prediction_graph),
    path('instrument/prediction_history_graph', views.instrument_prediction_history_graph),
    path('instrument/prediction', views.instrument_prediction),
    path('instrument/prediction_consensus', views.instrument_prediction_consensus),
    path('instrument/balance', views.instrument_balance),
    path('instrument/operations', views.instrument_operations),
    path('instrument/news_list_rated', views.instrument_news_list_rated),
    path('instrument/news_graph', views.instrument_news_graph),
    path('instrument/brand', views.instrument_brand),
    path('instrument/invest_calc', views.instrument_invest_calc),
    path('instrument/tech_analysis_graph', views.tech_analysis_graph),
