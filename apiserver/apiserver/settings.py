...
ALLOWED_HOSTS = ['home.urvanov.pro', 'localhost']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [],  # Полностью отключает аутентификацию
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Разрешает всем доступ к API
    ],
}
