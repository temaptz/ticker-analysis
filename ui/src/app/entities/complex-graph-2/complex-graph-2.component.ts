...
@Component({
  selector: 'complex-graph-2',
  imports: [CommonModule, PreloaderComponent],
  providers: [PriceFormatPipe],
  templateUrl: './complex-graph-2.component.html',
  styleUrl: './complex-graph-2.component.scss'
})
export class ComplexGraph2Component {
    ...
    effect(() => {
      ...
      combineLatest([
        ...
        .subscribe((resp: [InstrumentHistoryPrice[], PredictionGraphResp, Operation[]]) => {
          ...
          this.initChart(respHistory, respPredictions, respOperations);
        });
    });
  }
  ...
  private initChart(
    ...
    const chart = echarts.init(this.chartElRef?.nativeElement);
